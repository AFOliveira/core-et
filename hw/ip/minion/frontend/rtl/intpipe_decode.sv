...
#(
  ...
  always_comb begin
    casex (inst_bits)
      ...
      32'b1000000xxxxxxxxxx111xxxxx0101011: raw_inst_ctrl = {Y,N,N,N,N,N,Y,Y,A2_RS2,A1_RS1,IMM_X,DW_XPR,FN_BITMIXB,N,M_X,MT_X,N,N,N,N,N,Y,CSR_N,N,N,N,N,N}; // bitmixb

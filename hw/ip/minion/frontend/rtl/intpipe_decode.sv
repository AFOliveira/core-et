...
#(
  ...
  always_comb begin
    casex (inst_bits)
      ...
      // ── AIFlow custom decode (generated) ──
      // AIFLOW-CUSTOM-BEGIN (generated by aiflow apply --targets rtl; do not edit by hand)
      32'b1000000xxxxxxxxxx110xxxxx0101011: raw_inst_ctrl = {Y,N,N,N,N,N,Y,Y,A2_RS2,A1_RS1,IMM_X,DW_XPR,FN_PACKB,N,M_X,MT_X,N,N,N,N,N,Y,CSR_N,N,N,N,N,N}; // packb
      32'b1000000xxxxxxxxxx111xxxxx0101011: raw_inst_ctrl = {Y,N,N,N,N,N,Y,Y,A2_RS2,A1_RS1,IMM_X,DW_XPR,FN_BITMIXB,N,M_X,MT_X,N,N,N,N,N,Y,CSR_N,N,N,N,Y,N}; // bitmixb
      32'bxxxxxxxxxxxxxxxxx100xxxxx0101011: raw_inst_ctrl = {Y,N,N,N,N,N,N,Y,A2_IMM,A1_RS1,IMM_I,DW_XPR,FN_ADD,N,M_X,MT_X,N,N,N,N,N,Y,CSR_N,N,N,N,N,N}; // aif.europeriscvsummit
      // AIFLOW-CUSTOM-END

      // Legacy OP-32 encodings (reference for migration DV; remove when old opcode retired)
      32'b1000000xxxxxxxxxx110xxxxx0111011: raw_inst_ctrl = {Y,N,N,N,N,N,Y,Y,A2_RS2, A1_RS1, IMM_X, DW_XPR,FN_PACKB,  N,M_X,  MT_X,    N,N,N,N,N,Y,CSR_N,N,N,N,N,N}; // PACKB (old_opcode)
      32'b1000000xxxxxxxxxx111xxxxx0111011: raw_inst_ctrl = {Y,N,N,N,N,N,Y,Y,A2_RS2, A1_RS1, IMM_X, DW_XPR,FN_BITMIXB,N,M_X,  MT_X,    N,N,N,N,N,Y,CSR_N,N,N,N,Y,N}; // BITMIXB (old_opcode)

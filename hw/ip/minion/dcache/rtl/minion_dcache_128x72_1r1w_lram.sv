...
//
// minion_dcache_128x72_1r1w_lram — 128x72 registered-read RAM wrapper.

module minion_dcache_128x72_1r1w_lram
  import ram_cfg_pkg::*;
(
  input  logic        clk_i,
  ...
  output logic [71:0] rd_data_o,
  input  logic [71:0] wr_data_i,
  ...
  prim_rf_1r1w_reg_preview #(
    ...
    .wr_data_i            (wr_data_i[71:36]),
    .wr_addr_i            (wr_addr_i),
    .wr_en_i              (hi_wr_en),
    .rd_addr_i            (rd_addr_i),
    .rd_en_i              (hi_rd_en),
    .rd_data_o            (rd_data_o[71:36])
  );

  assign unused_ram_cfg = ^ram_cfg_i;

endmodule : minion_dcache_128x72_1r1w_lram
